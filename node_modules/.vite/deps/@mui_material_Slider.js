...
import {
  useControlled
} from "./chunk-KNUQH43O.js";
import {
  extractEventHandlers_default
} from "./chunk-MYHH5UVM.js";
import {
...
function focusThumb({
  ...
  if (!contains_default(sliderRef.current, activeElement) || Number(activeElement == null ? void 0 : activeElement.getAttribute("data-index")) !== activeIndex) {
    (_a = sliderRef.current) == null ? void 0 : _a.querySelector(`[type="range"][data-index="${activeIndex}"]`).focus();
  }
  if (setActive) {
