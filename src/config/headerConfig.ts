...
export const HEADER_CONFIG_BY_BRAND: Record<string, HeaderConfigState> = {
  next: { template: 'Club25', favourites: true, flag: false, storeLocator: false, myAccountLabel: false, helpLabel: false, uspMessage: true, uspMessageLabel: 'Next day delivery to home or free to store*', quickLink1: true, quickLink1Label: 'Store Locator', quickLink2: true, quickLink2Label: 'Help', subsiteLinks: false, searchFullWidth: false, megaFullWidth: false, 'nav.tab1': true, 'nav.tab1.label': 'WOMEN', 'nav.tab2': true, 'nav.tab2.label': 'MEN', 'nav.tab3': true, 'nav.tab3.label': 'BOYS', 'nav.tab4': true, 'nav.tab4.label': 'GIRLS', 'nav.tab5': true, 'nav.tab5.label': 'HOME', 'nav.tab6': true, 'nav.tab6.label': 'SCHOOL', 'nav.tab7': true, 'nav.tab7.label': 'BABY', 'nav.tab8': true, 'nav.tab8.label': 'HOLIDAY', 'nav.tab9': true, 'nav.tab9.label': 'BEAUTY', 'nav.tab10': true, 'nav.tab10.label': 'FURNITURE', 'nav.tab11': true, 'nav.tab11.label': 'BRANDS', 'nav.tab12': true, 'nav.tab12.label': 'GIFTS', 'nav.tab13': true, 'nav.tab13.label': 'SPORTS', 'nav.tab14': true, 'nav.tab14.label': 'CLEARANCE', 'nav.tab15': false, 'nav.tab15.label': 'Tab', 'nav.tab16': false, 'nav.tab16.label': 'Tab' },
