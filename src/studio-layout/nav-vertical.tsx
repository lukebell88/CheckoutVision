...
import { NavSectionMini, NavSectionVertical } from '../studio-nav/nav-section';
...
export function NavVertical({
  ...
  onToggleNav,
  checkPermissions,
  // Upstream NavVertical doesn't forward this, so it lands in `...other` and
  // React warns about an unknown DOM attribute. Destructured and passed through.
  enabledRootRedirect,
  layoutQuery = 'md',
  ...other
}: NavVerticalProps) {
  const renderNavVertical = () => (
    <>
      ...
      <Box sx={{ flex: '1 1 auto', overflowY: 'auto', minHeight: 0, display: 'flex', flexDirection: 'column' }}>
        <NavSectionVertical
          data={data}
          cssVars={cssVars}
