...
/**
 * NOTE: wrapped in forwardRef for React 18.
 *
 * Minimal 7.5 targets React 19, where `ref` is an ordinary prop on function
 * components, so upstream this is a plain function. `NavList` passes a ref here,
 * which on React 18 warns and yields a null ref. If this project moves to React
 * 19 the wrapper can go.
 */
