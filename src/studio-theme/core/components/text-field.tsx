...
type InputSizeProps = Pick<FilledInputProps, 'size' | 'hiddenLabel'> & {
  // Was `PickerTextFieldOwnerState` from @mui/x-date-pickers, which the studio
  // doesn't ship. The picker variants below are inert without it.
  ownerState?: { hiddenLabel?: boolean } & Record<string, unknown>;
};
