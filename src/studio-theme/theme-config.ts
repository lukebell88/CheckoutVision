...
export const themeConfig: ThemeConfig = {
  ...
  cssVariables: {
    cssVarPrefix: '',
    // The studio already drives light/dark with `data-theme` on <html> (set in
    // main.tsx before first paint, synced in App). Pointing MUI at the same
    // attribute keeps one source of truth instead of two that can disagree.
